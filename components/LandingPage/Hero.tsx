...
import LayerBlackTransparent from "./LayerBlackTransparent";

export default function Hero() {
  return (
    <section className="max-w-[1812px] mx-auto px-2">
      <div className="bg-[url('https://images.unsplash.com/photo-1468824357306-a439d58ccb1c?q=80&w=1959&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')] h-screen w-full bg-no-repeat bg-cover rounded-[2rem] flex flex-col justify-between items-center text-center py-8 relative px-4">
        <LayerBlackTransparent />
        <div className="text-white drop-shadow-2xl text-[2.2rem] md:text-[3.7rem] w-[95%] xl:text-[6rem] font-light">Secure Your Dream Vacation with a Reservation</div>
        ...
        <div className="flex items-center text-start justify-between w-[95%] text-white z-50">
            <div className="w-[50%] md:w-[30%] md:text-[1.2rem] font-light">
            We believe in the power of the great outdoors. We think that everyone deserved the chance to explore the wild and to find their very own adventure.</div>
